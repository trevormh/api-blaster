...
class SettingsCommand(Command):
    ...
    def __update_requests_directory(self):
        ...
        if new_dir:
            # cfg_copy = config.copy()  # make a copy in case the update fails, so we still have the original values to show
            ...
            # make the user enter a valid directory when this happens
                ...
                critical('Error occurred while updating requests directory')
